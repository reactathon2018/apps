...
//     var password = req.body.password;
//     var repsoneTxt;
//     console.log("came to login", req.username )
//     mongoose.model('Blob').findOne({'username': req.username}, function (err, blob) {
//         if (err) {
//             console.log('GET Error: There was a problem retrieving: ' + err);
//         } else {
//             console.log('GET Retrieving ID: ' + blob);
//             var blobdob = blob.dob.toISOString();
//             blobdob = blobdob.substring(0, blobdob.indexOf('T'))
//             res.format({
//                 json: function () {
//                     res.json(blob);
//                     repsoneTxt = res.json(blob);
//                 }
//             });
//         }
//     });
